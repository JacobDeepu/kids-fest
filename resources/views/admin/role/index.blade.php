            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div class="flex justify-between items-center">
                        @can('role create')
                        <x-link href="{{ route('role.create') }}" class="m-4">Create Role</x-link>
                        @endcan
                        <form class="m-4" method="GET" action="{{ route('role.index') }}">
                            <div class="flex w-56">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b">
                                ...
                                <td class="px-0 py-4 w-56">
                                    <x-link href="{{ route('role.edit', $role) }}">
                                    ...
                                    <form method="POST" action="{{ route('role.destroy', $role) }}" class="inline-block">
                                        @csrf
                                        @method('DELETE')
